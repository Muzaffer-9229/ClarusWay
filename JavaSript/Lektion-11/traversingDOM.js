...
console.log(h2.parentElement);  //? section.add-item (html e kadar cikilabilir)
console.log(h2.parentNode.parentNode.parentNode);  //? body (documente kadar cikilabilir)
...
console.log(htmlLi.closest("main").querySelector("section")); //? section.add-item
